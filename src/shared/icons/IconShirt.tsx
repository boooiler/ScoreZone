...
const IconShirt = ({ variant }: IconProps) => {

  switch (variant) {
  case 'filled':
    return (
      <svg width="800px" height="800px" viewBox="0 -7.72 127.24603 127.24603" xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 856 412" xmlSpace="preserve" version="1.1" y="0" x="0">
        <path fill="var(--shirt-color)"
