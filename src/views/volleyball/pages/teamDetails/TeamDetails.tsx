...
export const TeamDetails = () => {
  ...
  const { data, isLoading } = useVolleyballTeams(Number(teamId))
  const { data: leagueDetails, isLoading: isLoadingLeague } = useVolleyballLeagues(true, undefined, undefined, undefined, undefined, undefined, Number(teamId), "league")
